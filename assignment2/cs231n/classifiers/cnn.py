...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    #conv - relu - 2x2 max pool - affine - relu - affine - softmax
    #
    self.params['W1'] = np.random.normal(0,self.weight_scale, (num_filters, num_colors, filter_size, filter_size))#covnet parameters
    self.params['b1'] = np.random.normal(0,self.weight_scale, num_filters)

    #after the max pooling layer: need affine( input -> output)
